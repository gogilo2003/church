...
<template>
    ...
    <AppLayout>
        ...
        <div class="py-6 space-y-6 mx-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                <div v-for="stat in stats" :key="stat.name"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="inline-flex items-center justify-center p-2 rounded-xl text-xs font-bold" :class="{
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr v-if="!recentTenants.length">
                                <td colspan="5" class="px-4 py-8 text-center text-sm text-gray-500">
                                    ...
                                    <Link :href="route('central.register-tenant.create')"
                                        class="text-indigo-600 font-semibold hover:underline">Click here to register the
                                        first
                                        church.</Link>
                                </td>
                            </tr>
