...
const form = useForm({
    ...
    org_unit_id: props.member.org_unit?.id ?? '',
    household_id: props.member.household?.id ?? '',
    address: props.member.address ?? '',
    spiritual_milestones: {
        baptized: props.member.spiritual_milestones?.baptized ?? false,
        baptism_date: props.member.spiritual_milestones?.baptism_date ?? '',
        confirmed: props.member.spiritual_milestones?.confirmed ?? false,
        communion: props.member.spiritual_milestones?.communion ?? false,
    },
});
    ...
    <AppLayout>
        <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <PageHeader
                ...
                :description="`Update personal details, contact information, and milestones for ${member.full_name}.`"
                :back-route="route('members.show', member.id)"
            />
